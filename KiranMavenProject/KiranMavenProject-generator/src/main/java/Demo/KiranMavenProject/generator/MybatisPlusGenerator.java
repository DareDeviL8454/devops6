package Demo.KiranMavenProject.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "Demo.KiranMavenProject";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/KiranMavenProject-model"),
        mapper("/KiranMavenProject-dao"),
        mapperxml("/KiranMavenProject-web"),
        service("/KiranMavenProject-service"),
        web("/KiranMavenProject-web"),
        ;
